...
- **Search** - Users can search for available bookings by criteria like dates and location.
- **Make a Reservation** - Users can make a reservation after selecting an available booking.
- **View Reservations** - Users can view their active bookings.
- **Cancel a Reservation** - Users can cancel a reservation if needed.
